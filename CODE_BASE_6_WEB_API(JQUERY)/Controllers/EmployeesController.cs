...
namespace CODE_BASE_6_WEB_API_JQUERY_.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmployeesController : ControllerBase
    {
        private readonly CODE_BASE_6_WEB_API_JQUERY_Context _context;

        public EmployeesController(CODE_BASE_6_WEB_API_JQUERY_Context context)
        {
            _context = context;
        }
